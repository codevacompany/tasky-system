              ...
              <div v-else class="space-y-3">
                ...
                <div class="flex gap-3">
                  <button
                    ...
                    class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-primary hover:opacity-90 rounded-lg transition-colors"
                  >
                    Salvar
                  </button>
                  <button
                    @click="cancelEditingName"
                    class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200 text-sm font-medium rounded-lg transition-colors"
                  >
                    Cancelar
                  </button>
                </div>
